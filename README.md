...
1. 功能说明
即梦九宫格二十五宫生图，部分玩家需求替换其中的某一个镜头后，重新打包上传，所以做了个小应用。可以将一张图 分拆出25张图，也可以直接在当前页面替换掉某一个镜头后重新合并成一张图。


1. 编辑后的使用说明 (README.md)
您可以直接将以下内容复制并覆盖到项目的 README.md 中：

Markdown  折扣
# Mosaic-25

Mosaic-25 是一个基于 AI Studio 驱动的 9/25 宫格图片拆分与打包工具。它可以帮助用户快速将单张图片切分为适合社交媒体展示的宫格图。

![项目封面](https://www.zaomengshi.cn/favicon.ico) ## 🚀 功能特性

- **多模式切分**：支持 9 宫格（3x3）和 25 宫格（5x5）快速拆分。
- **AI 增强**：基于 Google Gemini API 的智能化处理逻辑。
